...
def main():
    driver = webdriver.PhantomJS(executable_path="./node_modules/phantomjs-prebuilt/bin/phantomjs", service_log_path='/var/log/phantomjs/ghostdriver.log') # or add to your PATH
